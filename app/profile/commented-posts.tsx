...
import { commentedPosts } from '@/constants/profileMockData';
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.header}>
        ...
        <ThemedText style={styles.headerTitle}>댓글 단 글</ThemedText>
        <View style={{ width: 24 }} />
      </View>
      ...
      {commentedPosts.length > 0 ? (
        <ScrollView style={styles.scrollView}>
          <View style={styles.section}>
            <ThemedText style={styles.countText}>총 {commentedPosts.length}개</ThemedText>
        ...
        <View style={styles.emptyContainer}>
          ...
          <ThemedText style={styles.emptyText}>댓글을 단 글이 없습니다</ThemedText>
        </View>
      )}
    </ThemedView>
  );
