...
import { bookmarkedPosts } from '@/constants/profileMockData';
      ...
      {bookmarkedPosts.length > 0 ? (
        <ScrollView style={styles.scrollView}>
          <View style={styles.section}>
            <ThemedText style={styles.countText}>총 {bookmarkedPosts.length}개</ThemedText>
        ...
        <View style={styles.emptyContainer}>
          ...
          <ThemedText style={styles.emptyText}>북마크한 글이 없습니다</ThemedText>
        </View>
      )}
    </ThemedView>
  );
