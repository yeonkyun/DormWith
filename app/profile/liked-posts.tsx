...
import { likedPosts } from '@/constants/profileMockData';
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.header}>
        ...
        <ThemedText style={styles.headerTitle}>좋아요한 글</ThemedText>
        <View style={{ width: 24 }} />
      </View>
      ...
      {likedPosts.length > 0 ? (
        <ScrollView style={styles.scrollView}>
          <View style={styles.section}>
            <ThemedText style={styles.countText}>총 {likedPosts.length}개</ThemedText>
            {likedPosts.map((post) => (
        ...
        <View style={styles.emptyContainer}>
          ...
          <ThemedText style={styles.emptyText}>좋아요한 글이 없습니다</ThemedText>
        </View>
      )}
    </ThemedView>
  );
