...
export default function ReceivedRequestsScreen() {
  ...
  const { receivedRequests } = useMatchingStore();
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.section}>
            <View style={styles.countBadge}>
              <ThemedText style={styles.countText}>{receivedRequests.length}건</ThemedText>
            </View>
              ...
              <View key={user.id} style={styles.requestCard}>
                ...
                <View style={styles.cardActions}>
                  <TouchableOpacity style={styles.rejectBtn}>
                    <ThemedText style={styles.rejectBtnText}>거절</ThemedText>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.acceptBtn}>
                    <Ionicons name="checkmark" size={16} color="#fff" />
                    <ThemedText style={styles.acceptBtnText}>수락</ThemedText>
                  </TouchableOpacity>
                </View>
              </View>
            ))}
